...
ALTER TABLE users
  ...
  ADD COLUMN current_plan_amount DECIMAL(10,2) NOT NULL DEFAULT 19.90 AFTER billing_block_reason,
...
CREATE TABLE user_billing (
  ...
  plan_code VARCHAR(50) NOT NULL DEFAULT 'STAYFLOW_STARTER',
  plan_name VARCHAR(100) NOT NULL DEFAULT 'StayFlow Starter',
  base_price DECIMAL(10,2) NOT NULL DEFAULT 19.90,
  ...
  calculated_amount DECIMAL(10,2) NOT NULL DEFAULT 19.90,
